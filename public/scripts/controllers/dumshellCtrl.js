...
app.controller('dumbshellCtrl', function ($scope, $timeout, $location,$interval,$routeParams) {
    ...
    for (var i = 0; i <= data; i++) {
        ...
        $scope.Dumbanwsers.push({ id: 2,Teamname:'b', sentence: ['Virat Kohli Cricketer', 'Hyderbad Biryani', 'The Indian Micheal Jackson'] });
        $scope.Dumbanwsers.push({ id: 3,Teamname:'c', sentence: ['The Laughing Buddha', 'Angry Birds', 'valentines day'] });
